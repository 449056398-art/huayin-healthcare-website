...
const coverageMarkers = [
  ['Heilongjiang', 76, 12, 'coverage'], ['Jilin', 72, 20, 'coverage'], ['Liaoning', 69, 27, 'service'], ['Inner Mongolia', 52, 20, 'coverage'], ['Beijing', 61, 29, 'coverage'], ['Tianjin', 64, 31, 'service'], ['Hebei', 59, 34, 'coverage'], ['Shandong', 63, 40, 'service'], ['Shanxi', 53, 38, 'coverage'], ['Ningxia', 45, 42, 'service'], ['Gansu', 37, 46, 'coverage'], ['Qinghai', 31, 55, 'coverage'], ['Shaanxi', 49, 48, 'service'], ['Henan', 56, 47, 'service'], ['Jiangsu', 65, 49, 'service'], ['Shanghai', 69, 54, 'coverage'], ['Anhui', 60, 53, 'coverage'], ['Zhejiang', 68, 59, 'coverage'], ['Hubei', 55, 58, 'service'], ['Sichuan', 43, 62, 'service'], ['Chongqing', 49, 64, 'service'], ['Jiangxi', 61, 62, 'service'], ['Hunan', 55, 68, 'service'], ['Fujian', 67, 67, 'service'], ['Guizhou', 47, 72, 'service'], ['Yunnan', 39, 78, 'service'], ['Guangxi', 48, 82, 'service'], ['Guangdong', 57, 80, 'service'], ['Hainan', 58, 91, 'coverage'],
]
...
function App() {
  return <div id="top">
    ...
    <main>
      ...
      <section className="china-coverage section-shell" id="coverage"><div className="coverage-copy"><p className="eyebrow blue">CHINA COVERAGE</p><h2>Local reach.<br/>Connected expertise.</h2><p>Huayin serves healthcare partners across 29 provincial-level regions in China. Our network includes 22 provincial-level service sites, with multiple sites operating in selected cities to meet local clinical and operational needs.</p><a className="text-button" href="#contact">Connect with Huayin <span>→</span></a></div><div className="coverage-panel" aria-label="China coverage visualization"><div className="coverage-caption"><i></i><span>China service network</span></div><div className="coverage-map"><div className="china-silhouette">{coverageMarkers.map(([name, left, top, type]) => <span className={`coverage-pin ${type}`} style={{ left: `${left}%`, top: `${top}%` }} title={name} aria-label={name} key={name}></span>)}</div><div className="south-china-inset"><small>South China Sea Islands</small><i></i><i></i><i></i><i></i></div></div><div className="coverage-legend"><span><i className="coverage-dot"></i>Coverage regions</span><span><i className="service-dot"></i>Service sites</span></div><div className="coverage-totals"><span><b>29</b> regions covered</span><span><b>22</b> service sites</span></div><details className="regional-locations"><summary>Key regional locations <span>+</span></summary><p>Guangzhou · Chengdu · Guangxi · Nanjing · Guizhou · Tianjin · Xiamen · Chongqing · Nanchang · Jinan · Liaoning · Shaanxi · Changsha · Zhengzhou · Kunming · Wuhan · Shizuishan · Heilongjiang</p></details></div></section>
