...
import './intelligence-visual.css'
import './about-headquarters.css'

const DiagnosticHologram = lazy(() => import('./DiagnosticHologram'))
...
function StandardSubpage({ content }) {
  ...
  return <div className="standard-subpage">
    ...
    {content.hologram && <Suspense fallback={<section className="diagnostic-hologram-loading" aria-label="Loading diagnostic body visualization" />}><DiagnosticHologram /></Suspense>}
...
function App() {
  ...
  return <div id="top" className={`${page}-mode ${standardPage ? 'subpage-mode' : ''}`}>
    ...
    <main>
      ...
      <section className="clinical-value section-shell" id="resources"><div className="clinical-value-copy"><p className="eyebrow blue">PROVEN IN REAL-WORLD PRACTICE</p><h2>More intelligence.<br/>More value in every diagnosis.</h2><p>As an intelligent pathology assistant, Huayin AI has been proven across millions of real-world cases to help healthcare teams work better.</p></div><div className="value-grid"><article className="value-efficiency"><div className="value-visual" aria-hidden="true"><img src={assetUrl('images/icon-efficiency.svg')} alt="" /></div><div><span>01 · CLINICAL FLOW</span><h3>Enhance efficiency</h3><p>Support pathologists with timely AI-assisted review and streamlined workflows.</p></div><b aria-hidden="true">↗</b></article><article className="value-cost"><div className="value-visual" aria-hidden="true"><img src={assetUrl('images/icon-calculator.svg')} alt="" /></div><div><span>02 · OPERATIONS</span><h3>Reduce costs</h3><p>Help laboratories optimize operations through connected digital pathology.</p></div><b aria-hidden="true">↗</b></article><article className="value-quality"><div className="value-visual" aria-hidden="true"><img src={assetUrl('images/icon-improvement.svg')} alt="" /></div><div><span>03 · DIAGNOSTIC QUALITY</span><h3>Improve quality</h3><p>Bring consistent intelligence to more diagnostic decisions, wherever patients are.</p></div><b aria-hidden="true">↗</b></article></div></section>
